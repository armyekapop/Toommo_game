...
{
	this->window = new sf::RenderWindow(sf::VideoMode(1080, 600), "toommmu", sf::Style::Close | sf::Style::Titlebar);
...
void Game::initWorld()
{
	if (!this->worldBackgroundTex.loadFromFile("picture/bgtoommo.jpg"))
	{
...
void Game::initPlayer()
{
	...
	this->player->setPosition(530.f, 520.f);
}
